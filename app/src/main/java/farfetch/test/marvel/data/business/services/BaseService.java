...
import farfetch.test.marvel.data.networking.exceptions.EmptyResponseException;
import farfetch.test.marvel.data.networking.exceptions.ErrorException;
import farfetch.test.marvel.data.networking.exceptions.InternetConnectionException;
import farfetch.test.marvel.data.networking.exceptions.NotFoundException;
import farfetch.test.marvel.data.networking.exceptions.ServerException;
import farfetch.test.marvel.data.networking.exceptions.UncheckedException;
